...
- Указать общие параметры задачи (см. раздел `Общие параметры задачи`_).
- Сформировать запрос к внешнему ресурсу (см. раздел `Формирование запроса к внешнему ресурсу`_).
- Сформировать геоописание для запроса к внешнему ресурсу (см. раздел `Формирование геоописания для запроса к внешнему ресурсу`_).
